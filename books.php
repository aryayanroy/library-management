        ...
        <div class="modal-dialog modal-fullscreen-sm-down">
            <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" class="modal-content">
                ...
                <div class="modal-body">
                    <label for="isbn" class="form-label">Enter the ISBN number of the book</label>
                    <div class="input-group">
                        <input type="text" id="isbn" class="form-control" placeholder="XX-XXXX-XXX-X">
                        <button type="button" id="isbn-validity" class="btn btn-primary">Check</button>
                    </div>
                </div>
