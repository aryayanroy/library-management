...
<script>
$(document).ready(function(){var l=window.location.href,o="<i class='fas fa-circle-notch fa-spin fa-xl'></i>";function c(t,a,e,n,l){t.append("<tr><td class='text-center'>"+(i+a)+"</td><td>"+e+"</td><td>"+n+"</td><td></td><td class='text-center'><button type='button' class='btn btn-primary btn-sm edit-btn' value='"+l+"' data-title='"+e+"'><i class='fa-solid fa-pen'></i></button></td><td class='text-center'><button type='button' class='btn btn-danger btn-sm delete-btn' value="+l+"><i class='fa-solid fa-trash'></i></button></td></tr>")}function r(d){d=d||($(".active[data-page]").data("page")?$(".active[data-page]").data("page"):1);var s=$("#data-table");s.find("tr:not(:first-child)").remove(),s.append("<tr><td colspan='6' class='text-center'>"+o+"</td></tr>"),$.post(l,{action:"load-data",page:d}).always(function(){s.find("tr:nth-child(2)").remove()}).done(function(t){var a=JSON.parse(t),t=a[2],e=25*(d-1)+1;if(1==a[0]){var n=a[1];for(i=0;i<n.length;i++){var l=n[i];null==l[1]&&(l[1]="-"),c(s,e,l[0],l[1],l[2])}$("#records-count").html(t);var o=Math.ceil(t/25),r="";for(i=1;i<=o;i++)r+="<li class='page-item'><a href='#' class='page-link' data-page="+i+">"+i+"</a></li>";$("#pagination").html(r),$("[data-page='"+d+"']").addClass("active")}else s.append("<tr><td colspan='5' class='text-center'>"+a[1]+"</td></tr>"),$("#records-count").html(0)})}r(),$(document).on("click",".page-link",function(t){t.preventDefault(),r($(this).data("page"))}),$("#insert-btn").click(function(){$(".action-text").html("Add record");var t=$(this),a=t.html();t.prop("disabled",!0).html(o),$.post(l,{action:"load-genre"}).always(function(){t.prop("disabled",!1).html(a)}).done(function(t){var a=$("#parent-genre");a.html("<option value='0'>None</option>");t=JSON.parse(t);if(1==t[0]){var e=t[1];for(i=0;i<e.length;i++){var n=e[i],l="<option value='"+n[0]+"'";a&&a==n[0]&&(l+="selected"),l+=">"+n[1]+"</option>",a.append(l)}}$("#data-modal").modal("show")})}),$("#data-form").submit(function(t){t.preventDefault();var a=$("#submit-btn"),e=a.html();a.prop("disabled",!0).html(o);t=$(this).serializeArray();t.push({name:"action",value:"insert"}),t=$.param(t),$.post(l,t).always(function(){a.prop("disabled",!1).html(e)}).done(function(t){t=JSON.parse(t);1==t[0]&&($("#data-form")[0].reset(),$("#data-modal").modal("hide"),r()),alert(t[1])})}),$(document).on("click",".edit-btn",function(){var t,a,e,n=prompt("Enter the Genre title",$(this).data("title"));n&&(""!=(n=$.trim(n))?(t=$(this),a=t.html(),t.prop("disabled",!0).html(o),e=t.val(),$.post(l,{action:"edit",title:n,id:e}).always(function(){t.prop("disabled",!1).html(a)}).done(function(t){t=JSON.parse(t);alert(t[1]),r()})):alert("Title cannot be empty"))}),$(document).on("click",".delete-btn",function(){var t=$(this),a=t.html(),e=t.val();confirm("Are you sure want to delete the record? This will also delete it's all related records.")&&(t.prop("disabled",!0).html(o),$.post(l,{action:"delete",id:e}).always(function(){t.prop("disabled",!1).html(a)}).done(function(t){t=JSON.parse(t);alert(t[1]),1==t[0]&&r()}))}),$("#search-form").submit(function(t){t.preventDefault();var a,e,t=$.trim($("#search-field").val());""!=t?(a=$("#search-btn"),e=a.html(),a.prop("disabled",!0).html(o),$.post(l,{action:"search",search:t}).always(function(){a.prop("disabled",!1).html(e)}).done(function(t){var a=$("#data-table");a.find("tr:not(:first-child)").remove(),$("#pagination>li").remove();t=JSON.parse(t);if(1==t[0]){var e=t[1],n=e.length;for(i=0;i<n;i++){var l=e[i];null==l[1]&&(l[1]="-"),c(a,1,l[0],l[1],l[2])}$("#records-count").html(n)}else a.append("<tr><td colspan='5' class='text-center'>"+t[1]+"</td></tr>"),$("#records-count").html(0)})):r()})});
</script>
</html>